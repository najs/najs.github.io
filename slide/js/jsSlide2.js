/* Created by njs2000 on 2016-12-06. */
var jsSlide = (function(){
	function jsSlide(options){
		...
		var settings = {
			autoPlay : false,
			effect : 'slide', // 'slide', 'fade', 'change'
			control : true,
			loop : false,


			//element
			containerClass : options.containerClass || '.jsSlide-wrap',
			jsSlideClass : options.jsSlideClass || '.jsSlide',
			pagingClass : options.pagingClass || '.jsSlide-paging',
			btnPrevClass : options.btnPrevClass || '.jsSlide-btn-prev',
			btnNextClass : options.btnNextClass || '.jsSlide-btn-next',
			pagingClass: options.pagingClass || '.jsSlide-paging',
			numberingClass : options.numberingClass || '.jsSlide-numbering',
			active : options.btnNextClass || 'now',
			speedDuration : options.speed || 2000
		},
		inits = {
